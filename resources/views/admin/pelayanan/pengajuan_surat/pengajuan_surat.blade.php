...
@section('content')
    @php
        ...
        $isKades = auth()->user()->role == 'kepala_desa';
    @endphp
            ...
            <div class="card overflow-hidden avtivity-card">
                <div class="card-body">
                    <div class="d-flex gap-md-4 gap-3 align-items-center">
                        ...
                        <div>
                            <p class="fs-14 mb-2">Total Pengajuan</p>
                            <span class="title text-black fs-28 fw-semibold">{{ $totalPengajuan }}</span>
                        </div>
                    </div>
                    <div>
                        <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                            <div class="progress-bar bg-success position-absolute rounded bootom-0"
                                style="width: 100%; height:5px;" aria-label="Progess-success" role="progressbar">
            ...
            <div class="card overflow-hidden avtivity-card">
                <div class="card-body">
                    <div class="d-flex gap-md-4 gap-3 align-items-center">
                        ...
                        <div>
                            <p class="fs-14 mb-2">Menunggu</p>
                            <span class="title text-black fs-28 fw-semibold">{{ $menunggu }}</span>
                        </div>
                    </div>
                    <div>
                        <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                            <div class="progress-bar rounded bg-secondary" style="width: 100%; height:5px;"
            ...
            <div class="card overflow-hidden avtivity-card">
                <div class="card-body">
                    <div class="d-flex gap-md-4 gap-3 align-items-center">
                        ...
                        <div>
                            <p class="fs-14 mb-2">Diproses</p>
                            <span class="title text-black fs-28 fw-semibold">{{ $diproses }}</span>
                        </div>
                    </div>
                    <div>
                        <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                            <div class="progress-bar rounded bg-danger" style="width: 100%; height:5px;"
            ...
            <div class="card overflow-hidden avtivity-card">
                <div class="card-body">
                    <div class="d-flex gap-md-4 gap-3 align-items-center">
                        ...
                        <div>
                            <p class="fs-14 mb-2">Selesai</p>
                            <span class="title text-black fs-28 fw-semibold">{{ $selesai }}</span>
                        </div>
                    </div>
                    <div>
                        <div class="progress position-absolute bottom-0 start-0 w-100" style="height:5px;">
                            <div class="progress-bar rounded bg-warning" style="width: 100%; height:5px;"
                                role="progressbar">
                                <span class="sr-only">42% Complete</span>
                            </div>
                        </div>
                        ...
                        <table id="example" class="display min-w850">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status Data</th>
                                    <th class="pe-4 text-end">Aksi Operasional</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <span class="fw-bold  mb-0.5">{{ $pengajuan->penduduk->nama }}</span>
                                                <small class="text-muted" style="font-size: 0.75rem;">NIK:
                                                    {{ $pengajuan->penduduk->nik }}</small>
                                            </div>
                                        </td>
                                        <td>
                                            <span class=" fw-medium">{{ $pengajuan->jenisSurat->nama_surat }}</span>
                                        </td>
                                        <td>
