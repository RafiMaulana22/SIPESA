                            ...
                            <tbody>
                                @foreach ($jenis as $get)
                                    <tr>
                                        ...
                                        <td>{{ $get->kode_surat }}</td>
                                        <td>{{ $get->kategorisurat->nama_kategori }}</td>
                                        <td>{{ $get->nama_surat }}</td>
                                        <td>
                                            @if ($get->is_active)
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">
                                            ...
                                            Detail Jenis Surat : {{ $get->nama_surat }}
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get->kode_surat }}"
                                                    readonly>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $get->nama_surat }}"
                                                    readonly>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="hidden" name="kode_surat"
                                                        value="{{ $get->kode_surat }}">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label">
                                                        Kategori Surat
                                                    </label>
                                                    <select name="kategori_surat_id" class="form-control" required>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="deskripsi" class="form-control" rows="4" placeholder="Masukkan deskripsi surat"></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">
                                    Status
