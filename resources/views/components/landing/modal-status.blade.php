        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden bg-white">
            ...
            <form id="formCekStatus">
                <div class="modal-body p-4">
                    ...
                    <div id="wrapper-input-pencarian">
                    ...
                    <div id="hasilStatus" style="display:none;">

                        <div class="alert alert-success rounded-3 mb-4 small d-flex align-items-center gap-2">
                            <i class="bi bi-check-circle-fill fs-5"></i> Data pengajuan berkas berhasil ditemukan.
                        </div>
                        ...
                        <div class="card border-0 bg-light-section border rounded-4 mb-4">
                            <div class="card-body p-4 small text-secondary">
                                <div class="row g-3">
                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Kode
                                            Pengajuan</label>
                                        <span id="status_kode" class="text-dark fw-bold fs-6"></span>
                                    </div>

                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Tanggal
                                            Pengajuan</label>
                                        <span id="status_tanggal" class="text-dark fw-medium"></span>
                                    </div>

                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Nama
                                            Warga</label>
                                        <span id="status_nama" class="text-dark fw-semibold"></span>
                                    </div>

                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Nomor
                                            NIK</label>
                                        <span id="status_nik" class="text-dark"></span>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Jenis
                                            Layanan</label>
                                        <span id="status_surat" class="text-dark fw-medium"></span>
                                    </div>

                                    <div class="col-6">
                                        <label class="text-muted d-block mb-1" style="font-size: 0.75rem;">Status
                                            Terkini</label>
                                        <div id="status_badge_container" class="mt-1">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="p-3 bg-white rounded-3 border">
                                            <label class="text-muted d-block mb-1 fw-medium"
                                                style="font-size: 0.75rem;"><i
                                                    class="bi bi-chat-left-text text-primary me-1"></i> Catatan Admin /
                                                Operator:</label>
                                            <span id="status_catatan" class="text-dark-emphasis lh-base d-block mt-1"
                                                style="font-size: 0.825rem;">-</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer border-0 p-0 gap-2">
                            <button type="button" class="btn btn-light rounded-3 px-4 fw-medium text-secondary w-100"
                                id="btnKembaliStatus">
